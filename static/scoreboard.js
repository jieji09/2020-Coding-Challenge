...
function addTeamView(id, name, score){
  var team_template = $("<div class='team-row'></div>");
  var name_template = $("<div class='team-name'></div>");
  var score_template = $("<div class='team-score'></div>");
  var button_template = $("<div class='button-container'></div>");
